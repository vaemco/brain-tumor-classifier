...
4.  Launch Jupyter Notebook:
    ...
    jupyter notebook
    ```
5.  In the browser, open `notebooks/train_resnet18.ipynb`.
6.  Run all cells to train the model.
    ...
    - The best model will be saved to `models/brain_tumor_resnet18_v2_trained.pt`.
...
3.  **Feedback**:
    - If the prediction is correct, click **Correct**.
    - If incorrect, click **Incorrect**, select the correct class from the dropdown, and click **Submit**.
