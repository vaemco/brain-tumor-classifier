...
MODEL_PATH = BASE_DIR.parent / "models" / "brain_tumor_resnet18_final.pt"
...
# Image display (left)
img_label = Label(main_frame, bg='#f0f0f0', text="No image loaded", 
                  width=25, height=12, relief='sunken')
